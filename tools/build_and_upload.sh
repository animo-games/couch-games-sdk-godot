#!/usr/bin/env bash
# macOS/Linux launcher for build_and_upload.gd. The export, zip and upload all
...
# build_and_upload.ps1 for the Windows equivalent.
# Usage: ./addons/couch-games-sdk/tools/build_and_upload.sh <game-slug>
set -euo pipefail
